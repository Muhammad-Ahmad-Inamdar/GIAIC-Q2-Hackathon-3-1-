  ...
  return (
    (<div className="w-[317px] h-[400px] rounded-[10px] bg-white relative shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out hover:scale-105 flex flex-col justify-between">
      ...
      <div className="p-4">
        ...
        <div className="absolute top-[24px] right-[24px] cursor-pointer" onClick={toggleHeart}>
          <Heart
            className={isLiked ? "fill-[#ED3F3F] text-[#ED3F3F]" : "text-[#90A3BF]"}
          />
        </div>
...
export default CartStructureDynamic;